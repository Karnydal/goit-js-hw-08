...
emailEl.addEventListener("input", (0, _lodashThrottleDefault.default)(onTextInput, 500));
messageEl.addEventListener("input", (0, _lodashThrottleDefault.default)(onTextInput, 500));
formEl.addEventListener("submit", onFormSubmit);
if (textInStorage) savedText();
...
function savedText() {
    ...
    if (Object.keys(textObject).includes("email")) emailEl.value = textObject.email;
    if (Object.keys(textObject).includes("message")) messageEl.value = textObject.message;
}
function onFormSubmit(event) {
    ...
    if (emailEl.value === "" || messageEl.value === "") alert("Please fill in all the fields!");
    else {
